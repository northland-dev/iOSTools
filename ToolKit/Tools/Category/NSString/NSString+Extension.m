...
- (NSString *)capitalizedCombineString{
    NSMutableArray *combineArr = [NSMutableArray arrayWithArray:[self componentsSeparatedByString:@"_"]];
    for (NSInteger i = 0; i < combineArr.count; i ++) {
        NSString *combineUnitStr = combineArr[i];
        combineArr[i] = [combineUnitStr capitalizedString];
    }
    return  [combineArr componentsJoinedByString:@"_"];    
}
