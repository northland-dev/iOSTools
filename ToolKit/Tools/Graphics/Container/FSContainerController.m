...
//
#import "FSContainerController.h"

CGFloat const FSContainerControllerAnimationTime = 0.28f;
@interface FSContainerController ()<UIGestureRecognizerDelegate>
{
...
@property(nonatomic,strong)UIViewController<FSSideControllerProtocol> *leftController;
...
@implementation FSContainerController
- (UIView *)overLayView {
    if (!_overLayView) {
         _overLayView = [[UIView alloc] init];
        [_overLayView setBackgroundColor:HexRGBAlpha(0x000000, 0.22)];
