...
{
    return  [[FSSharedLanguages SharedLanguage] CustomLocalizedStringFromTable:key Comment:nil Table:keyLanguageTable];
}
+ (NSString *)CustomLocalizedStringWithKey:(NSString *)key LanaguageType:(NSString *)language {
    
    return  [[FSSharedLanguages SharedLanguage] localizeStringWithResourceName:language withKey:key table:keyLanguageTable];
}
